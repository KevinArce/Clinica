...
<div class="panel-heading theme-patients"><span class="inlineicon edit-mini">Nuevo Paciente</span></div>
...
<form method="post" action="" enctype="multipart/form-data">
	<div class="form-group"><label>Genero:</label><select name='gender' class="form-control"  id='gender' size='1' ><option value='Male'>Male</option><option value='Female'>Female</option><option value='Other'>Other</option></select></div>
	<div class="form-group"><label>Edad:</label><select class="form-control"  name='age' id='age' size='1'>
	...
	<div class="form-group"><label>Nombre Completo:</label><input class="form-control" name="name" type="text"  placeholder="John Doe" /></div>
	<div class="form-group"><label>Numero de Contacto:</label><input class="form-control" name="contact" type="text" /></div>
	...
	<hr>
	<br>
	<div class="form-group"><label>Contacto de Ref.:</label><input class="form-control" name="ref_contact" type="text" /></div>
	<div class="form-group"><label>Peso:</label><input class="form-control" name="weight" type="text" /><i>(kg)</i></div>
	<div class="form-group"><label>Profesion:</label><input class="form-control" name="profession" type="text" /></div>
	<div class="form-group"><label>Email:</label><input class="form-control" name="email" type="text" /></div>
	<div class="form-group"><label>Direccion:</label><input class="form-control" name="address" type="text" /></div>
	<input name="submit" class="btn btn-default formbutton theme-patients" name="submit" class="formbutton patient" type="submit" value="Register">
</form> 
