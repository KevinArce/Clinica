...
<ol class="breadcrumb link-patients">
  ...
  <li><a href="../patients/">Paciente</a></li>
  <li class="active">Perfil</li>
</ol>

<table class="table table-striped link-patients"><tbody>
    <tr><td>Nombre</td><td><?php echo patient_info("name",$id);?></td></tr>
    <tr><td>Paciente ID</td><td><?php echo patient_info("serial",$id);?>-<?php echo patient_info("id",$id);?></td></tr>
    <tr><td>Registrado en</td><td><?php echo "$global_permission->guardian_short_name"; echo patient_info("branch",$id);?> - <?php echo branch_name(patient_info("branch",$id));?></td></tr>
    <tr><td>Registrado por</td><td><a class="staff" href="../staff/profile.php?id=<?php echo patient_info("physician",$id);?>"><?php echo staff_info("full_name",patient_info("physician",$id));?></a></td></tr>

    <?php if( patient_info("contact",$id) && display_permission('patient_contact')==true ):?>
    <tr><td>Contacto</td><td><?php echo patient_info("contact",$id);?></td></tr>
    <?php endif;?>
    ...
    <tr><td>Contacto de Ref.</td><td><?php echo patient_info("ref_contact",$id);?></td></tr>
    <?php endif;?>


    <?php if( patient_info("profession",$id) ):?>
    <tr><td>Profesion</td><td><?php echo patient_info("profession",$id);?></td></tr>
    <?php endif;?>

    <?php if( patient_info("address",$id) && display_permission('patient_address')==true ):?>
    <tr><td>Direccion</td><td><?php echo patient_info("address",$id);?></td></tr>
    <?php endif;?>


    <?php if( patient_info("weight",$id) ):?>
    <tr><td>Peso</td><td><?php echo patient_info("weight",$id);?></td></tr>
    <?php endif;?>


    <tr><td>Ultima Actualizacion</td><td><?php echo display_time(patient_info("last_update",$id));?></td></tr>
    <?php if(display_permission("register_patient")==true){
?><tr><td>Acciones</td><td><a class="patient" href="../patients/register-report.php?id=<?php echo $id;?>">Nuevo Reporte</a></td></tr><?php }?>
	<tr><td></td><td><?php if(display_permission("edit_patient")==true){?><a href="edit-patient.php?id=<?php echo $id;?>">Editar Perfil</a><?php }?></td></tr>
	<tr><td></td><td><?php if(display_permission("edit_patient")==true){?><a href="?id=<?php echo $id;?>&delete=1">Borrar Paciente y Datos asociados!</a><?php }?></td></tr>
</tbody></table>
    ...
    ?>
    <h4>Historial Clinico del Px</h4>
<table class="table table-striped link-patients table-reports"><tbody>
    <thead>
    <tr><td>ID</td><td width="60%">Sintomas</td><td>Estado</td><td>Actualizar</td></tr>
	</thead>
    	<?php 
