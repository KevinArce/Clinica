...
<div class="panel-heading theme-patients"><span class="inlineicon pending-mini">Reportes Pendientes</span></div>
...
<ol class="breadcrumb link-patients">
  ...
  <li class="active">Reportes Pendientes</li>
</ol>
    ...
    <thead>
    <tr><td>ID#</td><td width="50%">Sintomas</td><td></td><td>Estado</td><td>Fecha</td></tr>
	</thead>
	...
	<?php if($tcount==0){?>
		<h4 class="text-center">No hay reportes pendientes</h4>
	<?php }?>
