<?php
	...
	sns_header('Pacientes');
?>

<div id="patients-directory" class="container page">
<div class="panel panel-default">
  <div class="panel-heading theme-patients"><span class="inlineicon patients-mini">Paciente</span></div>
...
<ol class="breadcrumb link-patients">
  ...
  <li class="active">Pacientes</li>
    ...
    <div class="alert alert-success" role="alert">El cuadro clinico del paciente ha sido borrado exitosamente!</div>
	<?php }?>
