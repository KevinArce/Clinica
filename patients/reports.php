...
<ol class="breadcrumb link-patients">
  ...
  <li class="active">Reporte de Paciente</li>
</ol>
    ...
    <a class="btn btn-default formbutton theme-patients" href="prescribe.php?id=<?php echo "$id";?>">Editar</a>
	<?php }?>
   
    <div class="panel panel-default push_low">
    <div class="panel-heading _theme-patients">Acerca del Paciente</div>
    <div class="panel-body">
	 
    <table class="table table-striped link-patients  link-patients"><tbody>
    <tr><td>Paciente:</td><td><a href="../patients/profile.php?id=<?php echo $patient_id;?>" class="patient"><?php echo patient_info("name",$patient_id);?></a> | <?php echo patient_info("serial",$patient_id);?>-<?php echo patient_info("id",$patient_id);?></td></tr>
    <tr><td>Registrado en:</td><td><?php echo $global_permission->guardian_short_name; echo patient_info("branch",$patient_id);?> - <?php echo branch_name(patient_info("branch",$patient_id));?></td></tr>
