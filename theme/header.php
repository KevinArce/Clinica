    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
       ...
       <li class="dropdown mini">
          ...
          <ul class="dropdown-menu">
            <?php if(display_permission("register_patient")==true){?><li class="add"><a href="../patients/register-patient.php">Nuevo Paciente</a></li><?php }?>
            <?php if(display_permission("consumed_stock_local")==true){?><li class="info"><a href="../medicines/stocks.php">Local Stock</a></li><?php }?>
            <?php if(display_permission("pending_prescriptions")==true){?><li class="peding"><a href="../patients/pending-reports.php">Reportes Pendientes (<?php echo count_pending();?>)</a></li><?php }?>
          </ul>
        </li>
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="../staff/my-profile.php">Mi Perfil</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="../login/signout.php"><i class="glyphicon glyphicon-off"></i> Cerrar Sesion</a></li>
          </ul>
        </li>
