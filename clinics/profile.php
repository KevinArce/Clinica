...
<ol class="breadcrumb link-branches">
  ...
  <li class="active">Perfil</li>
    ...
    <div class="edit-button"><a class="btn btn-default formbutton theme-branches" href="edit.php?id=<?php echo "$clinic->id";?>">Editar Perfil</a></div>
    <?php } ?>
    <br><br>
    ...
    <div class="panel panel-default">
      <div class="panel-heading theme-bransches"><span class="inlineicon netwsork-mini">Estadisticas del Perfil</span></div>
    <div class="panel-body">
    ...
    <br>
      ...
      <div class="row">
        <div class="col-md-6">
        <table class="table table-striped link-branches"><tbody>
            <tr><td>Nuevo Paciente(s):</td><td><?php echo count_today_patients($branch_id,get_global('recent_hours'));?></td><td></td></tr>
            <tr><td>Nuevo Reporte(s):</td><td><?php echo count_today_reports($branch_id,get_global('recent_hours'));?></td><td></td></tr>
            <tr><td>Reporte(s) Pendiente(s):</td><td><?php echo count_today_preports($branch_id,get_global('recent_hours'));?></td><td></td></tr>
            <tr><td>Cargos por Medicina:</td><td><?php echo get_global('currency');?> <?php echo count_today_sales($branch_id,get_global('recent_hours'));?></td><td></td></tr>
        </tbody></table>
        </div>
        <div class="col-md-6">
        <table class="table table-striped link-branches"><tbody>
